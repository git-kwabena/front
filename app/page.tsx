    ...
    // <main className="flex min-h-screen flex-col items-center justify-between p-24">
        ...
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div className="font-light text-gray-500 sm:text-lg">
                <h2 className="mb-4 text-4xl font-extrabold text-gray-900">Customer Support</h2>
    ...
    <section className="bg-white">
        <div className="grid py-10 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div className="place-self-center mr-auto pb-4 lg:col-span-7">
                <h1 className="mb-4 max-w-2xl text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl">We handle every parcel size</h1>
                <p className="mb-6 max-w-2xl font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">No package is too big or too small for us! Our shipping website is fully equipped to handle parcels of any size, ensuring a smooth and reliable delivery experience for all your shipping needs.</p>
                ...
                <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100  dark:border-gray-700 dark:hover:bg-gray-300 dark:focus:ring-gray-800">
                    Speak to Sales
                </a> 
            </div>
