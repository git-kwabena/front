		...
		return (
			<div key={index}
				...
				<div className="relative flex flex-col items-center text-blue-500">
					<div className={`rounded-full transition duration-500 ease-in-out border-2 border-gray-700 h-12 w-12 flex items-center justify-center py-3  ${step.selected ? "bg-blue-500 text-white font-bold" : ""}`}>
